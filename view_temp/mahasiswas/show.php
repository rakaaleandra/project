...
<div class="flex justify-center items-start bg-gray-100 pt-10 min-h-screen">
    <div class="bg-white p-8 rounded shadow-md max-w-md w-full">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Detail Mahasiswa</h2>
        <div class="bg-white p-6 rounded shadow-md max-w-md">
            ...
            <a href="/project" class="inline-block bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Kembali</a>
        </div>
    </div>
</div>
