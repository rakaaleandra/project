...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-purple-100">
    <div class="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
        ...
        <form action="/project/doRegister" method="POST" class="space-y-5">
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500 mr-2"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M5.121 17.804A11.969 11.969 0 0112 15c2.21 0 4.27.64 5.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
            ...
            <div>
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500 mr-2"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l9 6 9-6M4 6h16v12H4z" />
                    </svg>
            ...
            <div>
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-500 mr-2"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M3 5h2l2 5-2 2c1 4 4 7 8 8l2-2 5 2v2c0 1-1 2-2 2-9 0-16-7-16-16 0-1 1-2 2-2z" />
                    </svg>
            ...
            <div>
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-purple-500 mr-2"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <input type="password" name="password"
                        required class="w-full outline-none text-gray-800 placeholder-gray-400"
                        placeholder="••••••••">
                </div>
            </div>
            ...
            <div class="flex items-center justify-between text-sm">
                ...
                <a href="/project/login" class="font-medium text-blue-500 hover:text-blue-600 transition">Masuk</a>
            </div>
